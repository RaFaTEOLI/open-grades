...
Route::group(["middleware" => "auth:api"], function () {
    Route::group(["middleware" => ["role:admin"]], function () {
        ...
        Route::get("/role/{id}", "API\RolesController@show")->middleware("permission:read-roles");

        Route::delete("/role/{id}", "API\RolesController@destroy")->middleware("permission:delete-roles");

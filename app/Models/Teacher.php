 ...
 * @OA\Property(property="created_at", type="string", readOnly="true", format="date-time", description="Datetime of when teacher was created", example="2019-02-25 12:59:20"),
 * @OA\Property(property="roles", type="object", ref="#/components/schemas/TeacherRoles"),
 * )
 *
 * Class Teacher
 *
